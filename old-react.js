  ...
  update() {
    ...
    let update = (oldNode, newNode) => {
      ...
      if (!isSameNode(oldNode, newNode)) {
        newNode[RENDER_TO_HTML](oldNode._range)
        return
      }
      ...
      for (let i; i < newNode.vChildren.length; i++) {
        let newChild = newNode.vChildren[i]
        let oldChild = oldNode.vChildren[i]
